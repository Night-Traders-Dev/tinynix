...
echo -e "${YELLOW}Loading tinynix custom configuration (4GB ext4, busybox init)...${NC}"
...
echo "  Rootfs:        $ROOTFS_SIZE (Buildroot)"
echo "  Architecture:  ARM64 (Cortex-A53)"
echo "  CPU Cores:     2 active (4 max)"
echo "  RAM:           1 GB"
echo "  Networking:    Enabled (DHCP via user-mode NAT)"
echo "  Init System:   busybox init (lightweight)"
echo ""
...
qemu-system-aarch64 \
        ...
        -device virtio-net-device,netdev=net0./scripts/config --enable CONFIG_EARLY_PRINTK
